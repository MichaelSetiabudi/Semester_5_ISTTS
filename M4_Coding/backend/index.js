...
let books = [
  ...
  },
  {
    ...
    author: "J.D. Salinger",
    image_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/89/The_Catcher_in_the_Rye_%281951%2C_first_edition_cover%29.jpg/220px-The_Catcher_in_the_Rye_%281951%2C_first_edition_cover%29.jpg",
    total_pages: 224,
  ...
  },
  {
    ...
    image_url: "https://m.media-amazon.com/images/M/MV5BNDczNzg4OTM3MV5BMl5BanBnXkFtZTcwOTQzMTEzMw@@._V1_.jpg",
    total_pages: 190,
  ...
  },
  {
    ...
    title: "The Alchemist",
    author: "Paulo Coelho",
    image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQhM2P-YDSJ1CTvekqJ29Nepvn69q6evyipFg&s",
    total_pages: 208,
...
// Modify your existing POST /api/books endpoint in the backend
...
app.post('/api/books', (req, res) => {
  ...
  // Validate total_pages is a number
...
app.delete('/api/users/:userId/books/:bookId', (req, res) => {
  ...
  usersBook[userId] = usersBook[userId].filter(book => book.id !== parseInt(bookId));
  res.sendStatus(204);
});
...
app.put('/api/users/:userId/books/:bookId', (req, res) => {
  ...
  const bookIndex = usersBook[userId].findIndex(b => b.id === parseInt(bookId));
  if (bookIndex === -1) {
    return res.status(404).json({ message: "Book not found" });
  }
